...
$topic = "";
	...
	if ($response_tuts->getStatusCode() == 200) {
		...
		$xpath = new DOMXpath($dom);
  		$articles = $xpath->query('//div[@class="feedable-details"]');
	...
	// TODO: Filter only the search results from Guzzle, use a class for this, use regex or http://php.net/manual/en/class.domdocument.php
?>
